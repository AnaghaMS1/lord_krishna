...
import 'package:lordkrishna/pages/homepage.dart';
...
class _MyListviewState extends State<MyListview> {
  ...
  final List<Map<String, dynamic>> companies = [
    {'name': 'Lord Krishna Construction', 'image': 'https://as2.ftcdn.net/v2/jpg/05/90/98/49/1000_F_590984956_sfLEosb32bWdY7nYRXlTGCagP7kVgWZD.jpg'},
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return Card(
                            child: ListTile(
                              ...
                              trailing: selectedCompanies.contains(companies[index]['name'])
                                  ? Icon(Icons.check_circle, color: Colors.green[700])
                                  : Icon(Icons.circle_outlined, color: Colors.grey),

                              onTap: () {
                                setState(() {
                                  if (selectedCompanies.contains(companies[index]['name'])) {
                                    selectedCompanies.remove(companies[index]['name']);
                                  } else {
                                    selectedCompanies.add(companies[index]['name']);
                                  }
                                });
                              },
                            ),
